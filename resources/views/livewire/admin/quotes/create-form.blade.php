<form id="quote-create-form" wire:submit="save" class="h-full flex flex-col">
        ...
        <div class="flex items-end gap-4">
            ...
            <div>
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <input wire:model.live="global_discount_value"
            ...
            <table class="min-w-max w-full text-sm border-collapse">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @php
                        ...
                        $discountAmt    = $grossItemTotal - (float)($item['total'] ?? $grossItemTotal);
                    @endphp
                    <tr class="group">
                        ...
                        <td class="py-2 pl-2">
                            <div class="flex flex-col gap-1">
                                ...
                                @if($discountAmt > 0.01)
                                <div class="text-[10px] text-danger-600 text-right tabular-nums leading-tight px-1.5">
                                    −{{ number_format($discountAmt, 0, '.', ' ') }}
                                </div>
                                @endif
                            </div>
                        </td>
