<form id="lead-edit-form" wire:submit="save" class="space-y-4">
    ...
    {{-- Won/Lost fields (conditional) --}}
    @if($status === 'won')
    <x-input
        label="Сумма сделки (UZS)"
        type="number"
        wire:model="won_amount"
        :error="$errors->first('won_amount')"
        placeholder="0"
    />
    @endif
    ...
    <x-select
        ...
        wire:model="lost_reason"
        :error="$errors->first('lost_reason')"
    >
