...
class CreateForm extends Component
{
    ...
    // Each item: product_id, name, sku, description, quantity, unit_price, discount_percent, total
    public array $items = [];

    // Recommendations for the selected customer's business type
    ...
    public function save(): void
    {
        ...
        $this->reset(['customer_id', 'contact_id', 'terms', 'notes', 'items',
    ...
    public function render()
    {
        ...
        return view('livewire.admin.quotes.create-form', [
            'contacts'             => $contacts,
